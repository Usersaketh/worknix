          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 max-w-xs">
              <a href={telegramUrl || '#'} target="_blank" rel="noopener noreferrer">
                <Button
                  type="button"
                  className="w-full justify-start gap-2 bg-[#229ED9] hover:bg-[#1d89bd] dark:bg-[#229ED9] dark:hover:bg-[#1a78a2] text-white border-none shadow-sm focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#229ED9]/60"
                >
              ...
              <a href={whatsappUrl || '#'} target="_blank" rel="noopener noreferrer">
                <Button
                  type="button"
                  className="w-full justify-start gap-2 bg-[#25D366] hover:bg-[#1fb457] dark:bg-[#25D366] dark:hover:bg-[#1ca64f] text-white border-none shadow-sm focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366]/60"
                >
                  <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true" fill="currentColor">
